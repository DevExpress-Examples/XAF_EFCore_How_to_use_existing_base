...
public class MyEFSolutionDesignTimeDbContextFactory : IDesignTimeDbContextFactory<MyEFSolutionEFCoreDbContext> {
	public MyEFSolutionEFCoreDbContext CreateDbContext(string[] args) {
